# Mrs Lari — AI Agent Context Document

This document provides comprehensive context for any AI agent working on the **Mrs Lari** project. Read this carefully to understand the architecture, design systems, and pending tasks before making any modifications.

## 1. Project Overview
**Mrs Lari** is a luxury editorial and booking website focused on heels, legs, and nylon content. It features a 5-page core structure plus legal pages, emphasizing direct booking, strict content protection, and a premium aesthetic.
